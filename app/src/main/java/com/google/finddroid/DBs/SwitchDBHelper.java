...
public class SwitchDBHelper extends SQLiteOpenHelper {
    //DB related var
    public static final String DB_NAME = "SwitchDB";
    public static final int DB_VERSION = 1;
    //table related var
    public static final String DB_TABLE_NAME = "switch";
    public static final String TABLE_KEY_ID = "id";
    public static final String TABLE_SWITCH_NAME = "switch_name";
    public static final String TABLE_SWITCH_CONTEXT = "switch_context";
    public static final String TABLE_SWITCH_STATE = "switch_state";
